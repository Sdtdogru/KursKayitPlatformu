            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Kurs Yönetimi</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="kurs.php">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-success o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Kurs Kayıt Geçmişi</div>
                </div>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-danger o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Öğrenci Giriş Geçmişi</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="giriskayitlari.php">
                  <span class="float-left">Gitmek İçin...</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
