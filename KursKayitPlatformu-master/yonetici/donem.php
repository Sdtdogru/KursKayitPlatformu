...
{
  $donem=$_POST['donem'];
$ret=mysqli_query($con,"insert into donem(donem) values('$donem')");
if($ret)
{
$_SESSION['msg']="Dönem Başarıyla Eklendi.";
}
else
{
  $_SESSION['msg']="Hata! Dönem Eklenirken Bir Hata Oluştu.";
}
}
if(isset($_GET['del']))
      {
              mysqli_query($con,"delete from donem where id = '".$_GET['id']."'");
                  $_SESSION['delmsg']="Dönem silindi!";
      }
?>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Dönem</li>
          </ol>
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="donem" name="donem" placeholder="" required />
  </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive table-bordered">
                                <table class="table">
                                    ...
                                    <tbody>
<?php
$sql=mysqli_query($con,"select * from donem");
$cnt=1;
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
  <a href="donem.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Dönemi silmek istediğinize emin misiniz?')">
